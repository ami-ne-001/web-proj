...
const rentNowDivs = document.querySelectorAll('.rent_now');

// Cart array to store rented items
const cartItems = JSON.parse(localStorage.getItem('cartItems')) || [];

// Add click event listeners to "Rent Now" divs
rentNowDivs.forEach((div) => {
    div.addEventListener('click', () => {
        // Get the image source and bike name from the parent elements
        const imageElement = div.closest('.text-center').querySelector('img');
        const bikeName = div.closest('.service').querySelector('h2').textContent;
        // alert
        ...
        // Optionally, show a confirmation or update the UI here
